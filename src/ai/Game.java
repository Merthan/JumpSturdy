                ...
                // Bot's Turn (Smart Move)
                    ...
                    if (!possibleMoves.isEmpty()) {
                        ...
                        if(!smartBot){
                            ...
                            List<byte[]> moveSequence = alphaBeta.findBestMove(board, isRedTurn, 2000);
...
/*            if(counter++>2){ //TODO: seems to not do anything when losing in the future is guaranteed? 1 player against two doesnt do anything
    ...
    public void botGame(BitBoard board) {
        ...
        while (true) {
            ...
            String botMove = Tools.parseMoveToString((new MerthanAlphaBetaExperiment().findBestMove(board, isRedTurn, 500)).get(0));
