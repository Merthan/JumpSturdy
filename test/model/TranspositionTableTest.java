...
public class TranspositionTableTest {
    ...
    void zobristKeyTest(){
        ...
        long test1= applyMoveTest("C7-C6",zobrist, zobrist.currentBoardKey, board);
        board.doMove("C7-C6",true,true);
        long test2= applyMoveTest("C2-C3",zobrist, test1, board);
        ...
        long test3= applyMoveTest("C2-C3",zobrist, zobrist.currentBoardKey, board2);
        board2.doMove("C2-C3",false,true);
        long test4= applyMoveTest("C7-C6",zobrist, test3, board2);
        //zobrist.applyMove(zobrist.currentBoardKey,)
    ...
    long applyMoveTest(String move,Zobrist zobrist,long zobristCurrentKey,BitBoard board){
